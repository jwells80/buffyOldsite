	...
	var _pub = {
		...
		show: function(obj, params) {
			...
			if (obj.getBoundingClientRect) {
				...
				// Original line: curtop += bounds.top + document.documentElement.scrollTop - 2;
				// tip from: http://www.codehouse.com/javascript/articles/scroll_area/
				curtop += bounds.top + (window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop) - 2;
			}
...
// ORIG: iBeginShare.plugins.builtin.bookmarks.addService('Twitter', 'http://twitter.com/home/?status=__TITLE__%3A%20__URL__');
iBeginShare.plugins.builtin.bookmarks.addService('Twitter', 'http://twitter.com/share?original_referer=__URL&text=__TITLE__&url=__URL__');
